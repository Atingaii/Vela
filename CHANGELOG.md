...
- A complete Xcode installation is required for `swift test`. Local Command Line Tools validation used the portable runner: 35/35 real-core test methods passed. RPC/MCP black-box checks also passed; portable execution is not XCTest.
