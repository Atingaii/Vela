...
pub fn tr(lang: &str, key: &str) -> &'static str {
    ...
    match (l, key) {
        ...
        ("pt-BR", "quit_app") => "Encerrar o Velo",
        ...
        ("zh", "quit_app") => "退出 Velo",
        ("zh-Hant", "quit_app") => "結束 Velo",
        ("ja", "quit_app") => "Velo を終了",
        ("ko", "quit_app") => "Velo 종료",
        ("ru", "quit_app") => "Выйти из Velo",
        ("uk", "quit_app") => "Вийти з Velo",
        (_, "quit_app") => "Quit Velo",
        ("zh", "settings") => "设置…",
        ("zh-Hant", "settings") => "設定…",
        ("ja", "settings") => "設定…",
        ("ko", "settings") => "설정…",
