...
pub fn tr(lang: &str, key: &str) -> &'static str {
    ...
    match (l, key) {
        ...
        ("pt-BR", "quit_app") => "Encerrar o Vela",
        ...
        ("zh", "quit_app") => "退出 Vela",
        ("zh-Hant", "quit_app") => "結束 Vela",
        ("ja", "quit_app") => "Vela を終了",
        ("ko", "quit_app") => "Vela 종료",
        ("ru", "quit_app") => "Выйти из Vela",
        ("uk", "quit_app") => "Вийти з Vela",
        (_, "quit_app") => "Quit Vela",
        ("zh", "settings") => "设置…",
        ("zh-Hant", "settings") => "設定…",
        ("ja", "settings") => "設定…",
        ("ko", "settings") => "설정…",
