...
final class IngestionRecallEligibilityTests: XCTestCase {
    ...
    func testSourceAndProjectRulesFilterLexicalSemanticAndRecentAcrossReopenWithoutDeletingMemories() throws {
        try fixture { base,project,store,foundation in
            ...
            _ = try store.put("memory",["id":"source-labeled","project":project.path,"scope":"project","state":"active","private":false,"sourceLabeledPrivate":true,"title":"source labeled","content":"needle source labeled","type":"fact"])
            ...
            XCTAssertEqual(try store.list("memory",project:project.path).count,6)
